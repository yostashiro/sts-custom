...
class ProductCategoryAdapter(Component):
    ...
    def _call(self, model, method, arguments):
        try:
            return super(ProductCategoryAdapter, self)._call(model, method, arguments)
    ...
    def search(self, filters=None, from_date=None, to_date=None):
        ...
        return self._call(self._odoo_model, 'search',
